...
void NTPClientRTC() {
  ...
  if (!cb) {
    ...
    if (((epoch  % 86400L) / 3600) + Timezone > 24) {
      setDS3231time(epoch % 60, (epoch  % 3600) / 60, ((epoch  % 86400L) / 3600)  - 24, 7, 31, 3, 18);
    }
    else {
      setDS3231time(epoch % 60, (epoch  % 3600) / 60, ((epoch  % 86400L) / 3600) , 7, 31, 3, 18);
    }
  }
