...
/*---------------------------------------Ten Number------------------------------------------*/
const int TenNumber[10][25] = {
  {20, 37, 36, 35, 34, 39, 44, 64, 59, 65, 70, 91, 96, 116, 111, 117, 122, 141, 140, 139, 138,}, // 0
  {06 , 44, 59, 70, 96, 111, 122,}, // 1
  {18, 37, 36, 35, 34, 44, 59, 70, 89, 88, 87, 86, 91, 116, 117, 141, 140, 139, 138}, // 2
  {18, 37, 36, 35, 34, 44, 59, 70, 89, 88, 87, 86, 96, 111, 122, 141, 140, 139, 138}, // 3
  {13, 39, 44, 64, 59, 65, 70, 89, 88, 87, 86, 96, 111, 122}, // 4
  {18, 37, 36, 35, 34, 39, 64, 65, 89, 88, 87, 86, 96, 111, 122, 141, 140, 139, 138}, // 5
  {21, 37, 36, 35, 34, 39, 64, 65, 89, 88, 87, 86, 91, 96, 116, 111, 117, 122, 141, 140, 139, 138}, // 6
  {10, 37, 36, 35, 34, 44, 59, 70, 96, 111, 122}, // 7
  {24, 37, 36, 35, 34, 39, 44, 64, 59, 65, 70, 89, 88, 87, 86, 91, 96, 116, 111, 117, 122, 141, 140, 139, 138}, // 8
  {17, 37, 36, 35, 34, 39, 44, 64, 59, 65, 70, 89, 88, 87, 86, 96, 111, 122}, // 9
};
/*---------------------------------------Digits Number------------------------------------------*/
const int DigitsNumber[10][25] = {
  {20, 30, 29, 28, 27, 46, 51, 57, 52, 72, 77, 98, 103, 109, 104, 124, 129, 134, 133, 132, 131,}, // 0
  {06, 51, 52, 77, 103, 104, 129,}, // 1
  {18, 30, 29, 28, 27, 51, 52, 77, 82, 81, 80, 79, 98, 109, 124, 134, 133, 132, 131,}, // 2
  {18, 30, 29, 28, 27, 51, 52, 77, 82, 81, 80, 79, 103, 104, 129, 134, 133, 132, 131,}, // 3
  {13, 46, 51, 57, 52, 72, 77, 82, 81, 80, 79, 103, 104, 129,}, // 4
  {18, 30, 29, 28, 27, 46, 57, 72, 82, 81, 80, 79, 103, 104, 129, 134, 133, 132, 131,}, // 5
  {21, 30, 29, 28, 27, 46, 57, 72, 82, 81, 80, 79, 98, 103, 109, 104, 124, 129, 134, 133, 132, 131,}, // 6
  {10, 30, 29, 28, 27, 51, 52, 77, 103, 104, 129,}, // 7
  {24, 30, 29, 28, 27, 46, 51, 57, 52, 72, 77, 82, 81, 80, 79, 98, 103, 109, 104, 124, 129, 134, 133, 132, 131,}, // 8
  {17, 30, 29, 28, 27, 46, 51, 57, 52, 72, 77, 82, 81, 80, 79, 103, 104, 129,}, // 9
};
/*---------------------------------------TEMHUM------------------------------------------*/
const int TEMHUM[2][3] = {
  {12, 12},
  {168, 12},
};
/*---------------------------------------NTP------------------------------------------*/
...
void ShowTendigitShow(int which) {
  for (int i = 1 ; i <= TenNumber[which][0]; i++) {
    Guan.setPixelColor(TenNumber[which][i], red[random(0, 255)], green[random(0, 255)], blue[random(0, 255)]);
  }
  Guan.show();
}

void ShowDigitsNumberShow(int which) {
  for (int i = 1 ; i <= DigitsNumber[which][0]; i++) {
    Guan.setPixelColor(DigitsNumber[which][i], red[random(0, 255)], green[random(0, 255)], blue[random(0, 255)]);
  }
  Guan.show();
}
